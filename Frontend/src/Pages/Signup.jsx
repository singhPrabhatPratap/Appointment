...
export default function Signup() {
  ...
  async function handleregister() {
    try {
      await axios
        .post(
          "http://localhost:4000/api/v1/user/User/Registered",
          {
            firstName,
            lastName,
            middleName,
      ...
      <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24 bg-green-100">
        <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
          ...
          <form action="#" method="POST" className="mt-8">
            <div className="space-y-5 grid grid-cols-2 gap-4 w-full">
              ...
              <div className="col-start-1 col-end-3">
                <button
                  ...
                  type="button"
                  className="inline-flex w-full items-center justify-center rounded-md bg-black px-3.5 py-2.5 font-semibold leading-7  bg-green-700 text-white hover:bg-black/80"
                >
